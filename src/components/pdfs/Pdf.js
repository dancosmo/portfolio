    ...
    <div className="Example">
      <Paper sx={{ backgroundColor: (theme) =>
        ...
        <Typography color="secondary"
          component="h1"
          variant="h4" sx={{textAlign:"center"}}>Curriculum Vitae</Typography>
      </Paper>
      ...
      <div className="Example__container">
        <Link
          ...
          target="_blank"
        >
          <Button variant="text"><Typography color="secondary" component="h1" variant="h6">{download}</Typography></Button>
        </Link>
